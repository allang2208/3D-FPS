...
export const StatusBar = {
    ...
    STATUS_CONFIG: {
        ...
        waxSealSlow: { icon: '🕯️', name: '封蜡减速', color: '#ba9272', desc: '封蜡诅咒使移动速度降低20%，持续2秒；再次命中只刷新时间，不叠层。' },
        ...
        corrosion: { icon: '🧪', name: '腐蚀', color: '#9ab84f', desc: '每层使物理防御降低 5%；每次倒计时结束只消退 1 层。' },
        ...
        petrified: { icon: '🗿', name: '石化', color: '#929292', desc: '持续期间停在当前动画帧，无法移动或执行任何动作；受到的魔法伤害提高 50%。' },
        flameArmor: { icon: '🔥', name: '灼锋焰甲', color: '#ff7a3a', desc: '攻击附带魔法伤害并迸发火花；每 0.5 秒灼烧周围敌人；武器持续上浮火焰粒子。' },
        electrified: { icon: '⚡', name: '感电', color: '#b98cff', desc: '每层使受到的电系伤害提高 3%；叠满 5 层触发过载：眩晕并释放电弧传导。' },
    },
