...
import { PLAYER_ANIMS, getSpriteFrameAtProgress } from '../config/player-anim.js';
import swordWalkGrip from '../../data/player-sword-walk-grip.json';
import swordWalkAtlas from '../../assets/player/sword-walk-grip/walk.json';
import swordComboGrip from '../../data/player-sword-combo-grip.json';
import swordComboAtlas0 from '../../assets/player/sword-combo-grip/combo-0.json';
import swordComboAtlas1 from '../../assets/player/sword-combo-grip/combo-1.json';
import dashSlashGrip from '../../data/player-dash-slash-grip.json';
import dashSlashAtlas0 from '../../assets/player/dash-slash-grip/slash-0.json';
import dashSlashAtlas1 from '../../assets/player/dash-slash-grip/slash-1.json';
...
import { resolveGunPose } from '../entities/player/anim-state.js';
...
const SWORD_COMBO_ATLASES = [swordComboAtlas0, swordComboAtlas1];
const SWORD_DASH_ATLASES = [dashSlashAtlas0, dashSlashAtlas1];
...
const DevTool = {
    ...
    state: {
        ...
        gunPoseKey: null,   // null=按武器自动；也可显式审计长枪/单手枪/双持分层
    },
    ...
    WEAPON_MAP: {
        ...
        m1911a1:    { name: 'M1911A1', img: WEAPON_TEX_PATH.weapon_m1911a1, type: 'pistol', configKey: 'm1911a1', weaponId: 'weapon49' },
        usp45:      { name: 'USP .45', img: WEAPON_TEX_PATH.weapon_usp45, type: 'pistol', configKey: 'usp45', weaponId: 'weapon50' },
        fiveSeven:  { name: 'FN Five-seveN', img: WEAPON_TEX_PATH.weapon_five_seven, type: 'pistol', configKey: 'fiveSeven', weaponId: 'weapon51' },
        eternalEdict: { name: '恒星圣谕', img: WEAPON_TEX_PATH.weapon_eternal_edict, type: 'pistol', configKey: 'eternalEdict', weaponId: 'weapon52' },
        falconEdict: { name: '猎隼裁令', img: WEAPON_TEX_PATH.weapon_falcon_edict, type: 'pistol', configKey: 'falconEdict', weaponId: 'weapon53' },
        crimsonCrownSettlement: { name: '赤冕清算', img: WEAPON_TEX_PATH.weapon_crimson_crown_settlement, type: 'pistol', configKey: 'crimsonCrownSettlement', weaponId: 'weapon54' },
        myriadCorridor: { name: '万象回廊', img: WEAPON_TEX_PATH.weapon_myriad_corridor, type: 'pistol', configKey: 'myriadCorridor', weaponId: 'weapon55' },
        pkm:        { name: 'PKM',        img: WEAPON_TEX_PATH.weapon_pkm,      type: 'machinegun', configKey: 'pkm', weaponId: 'weapon6' },
        rpd:        { name: 'RPD',        img: WEAPON_TEX_PATH.weapon_rpd,      type: 'machinegun', configKey: 'rpd', weaponId: 'weapon31' },
        m249:       { name: 'M249 SAW',   img: WEAPON_TEX_PATH.weapon_m249,     type: 'machinegun', configKey: 'm249', weaponId: 'weapon32' },
        ultimax100: { name: 'Ultimax 100 Mk8', img: WEAPON_TEX_PATH.weapon_ultimax100, type: 'machinegun', configKey: 'ultimax100', weaponId: 'weapon33' },
        mg42:       { name: 'MG42',       img: WEAPON_TEX_PATH.weapon_mg42,     type: 'machinegun', configKey: 'mg42', weaponId: 'weapon34' },
        fusion_core_lmg: { name: '熔核轻机枪', img: WEAPON_TEX_PATH.weapon_fusion_core_lmg, type: 'machinegun', configKey: 'fusion_core_lmg', weaponId: 'weapon35' },
        singularity_loom_lmg: { name: '奇点织机', img: WEAPON_TEX_PATH.weapon_singularity_loom_lmg, type: 'machinegun', configKey: 'singularity_loom_lmg', weaponId: 'weapon36' },
        celestial_cartographer_lmg: { name: '天穹测绘者', img: WEAPON_TEX_PATH.weapon_celestial_cartographer_lmg, type: 'machinegun', configKey: 'celestial_cartographer_lmg', weaponId: 'weapon37' },
        grave_covenant_cantor_lmg: { name: '冥约颂炮', img: WEAPON_TEX_PATH.weapon_grave_covenant_cantor_lmg, type: 'machinegun', configKey: 'grave_covenant_cantor_lmg', weaponId: 'weapon38' },
        akm:        { name: 'AKM',        img: WEAPON_TEX_PATH.weapon_akm, type: 'rifle', configKey: 'akm', weaponId: 'weapon7' },
        stg44:      { name: 'STG-44',     img: WEAPON_TEX_PATH.weapon_stg44, type: 'rifle', configKey: 'stg44', weaponId: 'weapon23' },
        m416:       { name: 'M416',       img: WEAPON_TEX_PATH.weapon_m416, type: 'rifle', configKey: 'm416', weaponId: 'weapon21' },
        qbz95:      { name: 'QBZ-95',     img: WEAPON_TEX_PATH.weapon_qbz95, type: 'rifle', configKey: 'qbz95', weaponId: 'weapon24' },
        frontier_rifle: { name: '边境突击步枪', img: WEAPON_TEX_PATH.weapon_frontier_rifle, type: 'rifle', configKey: 'frontier_rifle', weaponId: 'weapon25' },
        vengeance_rifle: { name: '复仇之神', img: WEAPON_TEX_PATH.weapon_vengeance_rifle, type: 'rifle', configKey: 'vengeance_rifle', weaponId: 'weapon26' },
        astral_tide_rifle: { name: '星潮协议', img: WEAPON_TEX_PATH.weapon_astral_tide_rifle, type: 'rifle', configKey: 'astral_tide_rifle', weaponId: 'weapon27' },
        zero_point_rifle: { name: '零点仲裁', img: WEAPON_TEX_PATH.weapon_zero_point_rifle, type: 'rifle', configKey: 'zero_point_rifle', weaponId: 'weapon28' },
        corona_cadence_rifle: { name: '日冕裁律', img: WEAPON_TEX_PATH.weapon_corona_cadence_rifle, type: 'rifle', configKey: 'corona_cadence_rifle', weaponId: 'weapon29' },
        terminal_echo_rifle: { name: '终末回声', img: WEAPON_TEX_PATH.weapon_terminal_echo_rifle, type: 'rifle', configKey: 'terminal_echo_rifle', weaponId: 'weapon30' },
        ...
        s686:       { name: 'S686', img: WEAPON_TEX_PATH.weapon_s686, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon39' },
        m870_breacher: { name: 'M870 短管型', img: WEAPON_TEX_PATH.weapon_m870_breacher, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon40' },
        ksg12:      { name: 'KSG-12', img: WEAPON_TEX_PATH.weapon_ksg12, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon41' },
        spas12:     { name: 'SPAS-12', img: WEAPON_TEX_PATH.weapon_spas12, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon42' },
        aa12:       { name: 'AA-12', img: WEAPON_TEX_PATH.weapon_aa12, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon43' },
        winchester1887: { name: 'Winchester 1887', img: WEAPON_TEX_PATH.weapon_winchester1887, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon44' },
        terminus_pendulum: { name: '末日钟摆', img: WEAPON_TEX_PATH.weapon_terminus_pendulum, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon45' },
        void_funeral_tide: { name: '虚空葬潮', img: WEAPON_TEX_PATH.weapon_void_funeral_tide, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon46' },
        black_sun_verdict: { name: '黑日圣裁', img: WEAPON_TEX_PATH.weapon_black_sun_verdict, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon47' },
        royal_hunt_finale: { name: '王猎终局', img: WEAPON_TEX_PATH.weapon_royal_hunt_finale, type: 'shotgun', configKey: 'shotgun', weaponId: 'weapon48' },
    ...
    // 面板武器键 → Phaser 纹理键。逐贴图抓握点必须用纹理键读取，不能用面板键
    // 或共享 configKey（shotgun）代替。
    _textureKeyOf(type = this.state.weaponType) {
        const path = this.WEAPON_MAP[type]?.img;
        return Object.keys(WEAPON_TEX_PATH).find(key => WEAPON_TEX_PATH[key] === path) || null;
    },

    _isDualGunPreview() {
        return this._gunPoseKeyFor() === 'gun_idle_dual'
            && this.WEAPON_MAP[this.state.weaponType]?.type === 'pistol';
    },

    _applyDualPreviewOffset(local) {
        if (!this._isDualGunPreview()) return local;
        const dualOffsetX = WeaponAnimConfig[this._configKeyOf(this.state.weaponType)]?.dualOffsetX || 0;
        return { ...local, x: local.x + dualOffsetX };
    },
    ...
    // aimSpriteOffset/dualOffsetX 依赖瞄准态/副手实例，面板只展示提示；移动 bob 已与运行时同源模拟。
    ...
    _applyRenderOffsets(local, rotation) {
        ...
        const bob = this._gunMovementBob(PLAYER_DEFAULTS.physics.spriteSize);
        return {
            local: {
                ...local,
                x: local.x + off.spriteOffsetX + bob.x * off.bobWeaponScale,
                y: local.y + off.spriteOffsetY + bob.y * off.bobWeaponScale,
            },
    ...
    _mirrorForFacing(local, rotation) {
        ...
        return {
            ...
            rotation: local.gripAnchor ? -rotation : Math.PI - rotation,
        };
    },
    ...
    switchTab(tabName) {
        ...
        // 更新 tab 按钮状态
        this._panel.querySelectorAll('.dev-tool-tab').forEach(tab => {
        ...
        // 更新 tab 内容显示
        this._panel.querySelectorAll('.dev-tool-tab-content').forEach(content => {
    ...
    _exportPerFrameFile(wt, cfg, panelWt = wt) {
        ...
        // 普攻/普通冲刺抓握已经由前一个 _persistWeaponConfig 全量保存。
        // 旧逐帧导出端不认识这些独立块，会错误回写 attack；不能再经过该合并入口。
        if (this._isSwordGripAnim(this.state.anim)) return Promise.resolve();
        const payload = {
    ...
    _seedPerFrameDefaults(wt, anim = 'attack') {
        ...
        if (this._isSwordGripAnim(anim)) {
            // 按原生帧数重置抓握，不复制旧attack轨迹或播种30帧。
            const defaults = anim === 'dash' ? dashSlashGrip.defaults : swordComboGrip.defaults[anim];
            const frames = defaults.map(frame => ({ ...frame }));
            WeaponAnimConfig[cfgKey][key] = { type: 'perFrame', anchor: 'grip', frames };
            return frames;
        }
    ...
    _getPerFrameTransform() {
        ...
        const anim = this.state.anim;
        const textureKey = Object.keys(WEAPON_TEX_PATH).find(key => WEAPON_TEX_PATH[key] === this.WEAPON_MAP[this.state.weaponType]?.img);
        if (anim === 'idle' && wt === 'sword' && this.state.weaponType !== 'staff' && swordWalkGrip.idle) {
            const grip = WeaponTransform.getSwordIdleGripPose(swordWalkGrip.idle, textureKey,
                this._buildPreviewOverrides(), PLAYER_DEFAULTS.physics.spriteSize);
            return { local: { x: grip.x, y: grip.y, size: grip.height/grip.scale, scale: grip.scale,
                gripAnchor: true, gripX: grip.gripX, gripY: grip.gripY }, rotation: grip.rotation };
        }
        const perFrame = this._getPerFrameFrames(wt, anim);
        if (!perFrame || !this._isPerFrameAnim(anim)) return null;

        if (this._isSwordGripAnim(anim)) {
            const frame = perFrame[this._gripPreviewFrame(anim)];
            const grip = WeaponTransform.getSwordGripFramePose(frame, textureKey);
            if (!grip) return null;
            const size = WeaponTransform.getWeaponSize('sword', frame.scale, 'attack');
            return { local: { x: grip.x, y: grip.y, size: size.height/frame.scale, scale: frame.scale,
                gripAnchor: true, gripX: grip.gripX, gripY: grip.gripY }, rotation: grip.rotation,
                stretchX: frame.stretchX ?? 1, stretchY: frame.stretchY ?? 1,
                blurX: grip.blurX, blurY: grip.blurY };
        }
    ...
    _bindEvents() {
        ...
        if (animSelect) {
            animSelect.addEventListener('change', (e) => {
                const previousAnim = this.state.anim;
                const previousFrame = this.state.frameIndex;
                const nextAnim = e.target.value;
                if (['gun_idle', 'gun_idle_pistol', 'gun_idle_dual'].includes(nextAnim)) {
                    this.state.gunPoseKey = nextAnim;
                    this._syncGunPoseSelect();
                }
                this.state.anim = nextAnim;
                this.state.frameIndex = this._mapGunLocomotionFrame(previousAnim, previousFrame, nextAnim);
        ...
        const gunPoseSelect = getElement('devToolGunPoseSelect');
        if (gunPoseSelect) {
            gunPoseSelect.addEventListener('change', (e) => {
                this.state.gunPoseKey = e.target.value || null;
                this._draw();
            });
        }
        ...
        // 浮动工具内的键盘操作不穿透到游戏；保留输入框和原生控件默认行为。
        document.addEventListener('keydown', (e) => {
            if (!this._active || Game._paused) return;
            const editing = e.target?.closest?.('input, textarea, select, [contenteditable="true"]');
            if (e.key === 'Escape' || (!editing && e.code === 'KeyT')) {
                e.preventDefault();
                e.stopImmediatePropagation();
                if (!e.repeat) this.hide();
                return;
            }
            if (this._panel.contains(e.target)) e.stopPropagation();
            if (this._currentTab === 'weapon' && this._panel.contains(e.target) && !editing && e.key.toLowerCase() === 'r') {
                e.preventDefault();
                e.stopPropagation();
                if (!e.repeat) this._toggleMode();
            }
        });
    ...
    _loadCharacterFrames() {
        this._charFrames = {};
        // 剑步行与正式显示共用紧裁图集；法杖仍使用原来的手层。
        this._swordWalkImage = new Image();
        this._swordWalkImage.onload = () => { this._draw(); };
        this._swordWalkImage.src = swordWalkGrip.pages[0].image;
        this._swordComboImages = swordComboGrip.pages.map(page => {
            const image = new Image();
            image.onload = () => this._draw();
            image.src = page.image;
            return image;
        });
        this._swordDashImages = dashSlashGrip.pages.map(page => {
            const image = new Image();
            image.onload = () => this._draw();
            image.src = page.image;
            return image;
        ...
        // 持枪模式移动预览部件（walk/run 腿 sheet + 躯干层，与游戏内分层一致）。
        ...
        for (const poseKey of ['gun_idle', 'gun_idle_pistol', 'gun_idle_dual']) {
            ...
            const rl = gunTwist.runLegs;
            const [rlStart, rlEnd] = rl?.frames || [0, (rl?.frameCount || 1) - 1];
            const layer = {
                walkFrames: {
                    sheet: new Image(),
                    cols: wl.cols || 8,
                    ...
                    frameRate: wl.frameRate || 12,
                    bodyBobY: wl.bodyBobY || [],
                    bodyBobX: wl.bodyBobX || [],
                    bobScale: wl.bobScale ?? 1,
                    bobXScale: wl.bobXScale ?? 0.5,
                },
                runFrames: rl ? {
                    sheet: new Image(),
                    cols: rl.cols || 8,
                    frameW: rl.frameWidth,
                    frameH: rl.frameHeight,
                    firstFrame: rlStart,
                    count: rlEnd - rlStart + 1,
                    frameRate: rl.frameRate || 12,
                    bodyBobY: rl.bodyBobY || [],
                    bodyBobX: rl.bodyBobX || [],
                    bobScale: rl.bobScale ?? 1,
                    bobXScale: rl.bobXScale ?? 0.5,
                } : null,
                idleLegs: null,
                torso: null,
                arm: null,
                armCfg: gunTwist.arm || null,
                torsoShiftX: gunTwist.torsoShiftX || 0,
                torsoShiftY: gunTwist.torsoShiftY || 0,
            };
            layer.walkFrames.sheet.onload = () => { this._draw(); };
            layer.walkFrames.sheet.src = wl.src;
            if (layer.runFrames) {
                layer.runFrames.sheet.onload = () => { this._draw(); };
                layer.runFrames.sheet.src = rl.src;
            }
            ...
            if (gunTwist.legsSrc) {
                layer.idleLegs = new Image();
                layer.idleLegs.onload = () => { this._draw(); };
                layer.idleLegs.src = gunTwist.legsSrc;
            }
            if (gunTwist.arm?.src) {
                layer.arm = new Image();
                layer.arm.onload = () => { this._draw(); };
                layer.arm.src = gunTwist.arm.src;
            }
            this._gunLayers[poseKey] = layer;
        }
    },

    // 面板武器类型 → 持枪姿态。显式选择优先；自动模式按长枪/手枪回退。
    _gunPoseKeyFor() {
        if (this.state.gunPoseKey && this._gunLayers?.[this.state.gunPoseKey]) {
            return this.state.gunPoseKey;
        }
    ...
    _syncGunPoseSelect() {
        const select = getElement('devToolGunPoseSelect');
        if (select) select.value = this.state.gunPoseKey || '';
    },

    _gunMovementFrames(anim = this.state.anim) {
        const layer = this._gunLayers?.[this._gunPoseKeyFor()] || this._gunLayers?.gun_idle;
        if (!layer) return null;
        if (anim === 'walk') return layer.walkFrames;
        if (anim === 'running') return layer.runFrames;
        return null;
    },

    _mapGunLocomotionFrame(previousAnim, previousFrame, nextAnim) {
        if (!['walk', 'running'].includes(previousAnim) || !['walk', 'running'].includes(nextAnim)) return 0;
        const previousFrames = this._gunMovementFrames(previousAnim);
        const nextFrames = this._gunMovementFrames(nextAnim);
        if (!previousFrames?.count || !nextFrames?.count) return 0;
        const wrappedFrame = ((previousFrame % previousFrames.count) + previousFrames.count) % previousFrames.count;
        const phase = wrappedFrame / previousFrames.count;
        return Math.min(nextFrames.count - 1, Math.floor(phase * nextFrames.count));
    },

    _gunMovementBob(spriteSize) {
        const frames = this._gunMovementFrames();
        if (!frames?.count) return { x: 0, y: 0 };
        const index = ((this.state.frameIndex % frames.count) + frames.count) % frames.count;
        return {
            x: -(frames.bodyBobX[index] || 0) * (spriteSize / frames.frameW) * frames.bobXScale,
            y: (frames.bodyBobY[index] || 0) * (spriteSize / frames.frameH) * frames.bobScale,
        };
    },
    ...
    _perFrameCfgKey(anim) {
        if (this._isSwordGripAnim(anim)) return `${anim}Grip`;
        if (anim === 'walk') {
    ...
    _isSwordGripAnim(anim) {
        return this.state.weaponType !== 'staff' && this._configKeyOf(this.state.weaponType) === 'sword'
            && (anim === 'attack' || anim === 'attack2' || anim === 'attack3' || anim === 'dash');
    },
    _gripPreviewFrame(anim) {
        if (!this.state.isPlaying) return this.state.frameIndex;
        const def = PLAYER_ANIMS[this.PANEL_ANIM_TO_CONFIG[anim]];
        const p = this.state.playProgress || 0;
        return this._isFpsManual()
            ? Math.min(def.frameCount-1, Math.floor(p*def.frameCount))
            : getSpriteFrameAtProgress(this.PANEL_ANIM_TO_CONFIG[anim], p);
    },
    ...
    _startFrameAnimation() {
        ...
        if (isPerFrame) {
            ...
            const duration = this.state.anim === 'dash' && this._isSwordGripAnim('dash') && !this._isFpsManual()
                ? dashSlashGrip.attackReferenceMs : (frameData.durations && !this._isFpsManual())
            ...
            const loop = (timestamp) => {
                ...
                this.state.frameIndex = this._isSwordGripAnim(this.state.anim)
                    ? this._gripPreviewFrame(this.state.anim)
                    : Math.min(perFrame.length - 1, Math.floor(progress * perFrame.length));
                this._updateFrameLabel();
                const slider = getElement('devToolFrameSlider');
                if (slider) slider.value = this.state.frameIndex;
                this._draw();
    ...
    _getWeaponDrawState() {
        ...
        return this._mirrorForFacing(this._applyDualPreviewOffset(base.local), base.rotation);
    },

    // 双持姿态的副手预览。主/副手使用相同的逐枪纹理、抓握坐标、渲染偏移和
    // 朝向镜像，只在 WeaponTransform 的 isOffhand 锚点上分流。
    _getOffhandWeaponDrawState() {
        if (!this._isDualGunPreview()) return null;
        const wt = this._configKeyOf(this.state.weaponType);
        const animState = this._stateKeyOf(this.state.anim);
        const overrides = this._staffStateOverrides(animState, this._buildPreviewOverrides());
        const base = this._applyRenderOffsets(
            WeaponTransform.getWeaponLocalOffset(wt, WEAPON_ANIM.size, true, false, animState, true, overrides),
            WeaponTransform.getWeaponRotation(0, wt, 0, animState, true, overrides)
        );
        return this._mirrorForFacing(this._applyDualPreviewOffset(base.local), base.rotation);
    },
    ...
    _hitTestWeapon(px, py, local, drawScale) {
        ...
        if (weaponType === 'melee') {
            ...
            w = h * ((img.naturalWidth || 1) / Math.max(1, img.naturalHeight || 1));
            const grip = WeaponTransform.getTextureGrip(
                this._configKeyOf(this.state.weaponType),
                this._textureKeyOf(),
                { width: w, height: h }
            );
    ...
    _drawHandLayer(cx, cy, spriteSize) {
        ...
        if (hl.comboFrame) {
            this._drawSwordComboPart(hl.comboFrame, cx, cy, hl.displaySize, hl.dash);
        } else if (hl.atlasFrame) {
            this._drawSwordWalkPart(hl.atlasFrame, cx, cy, spriteSize);
        } else {
            ctx.drawImage(
                hl.img,
    ...
    // T 面板持枪手臂条：按运行时同一肩点/自然角公式，把手心严格旋到主手抓握锚点。
    // 这样面板不再只显示“裸枪 + 躯干”，可以直接复核走/跑、左右朝向和双持姿态的衔接。
    _drawGunArmLayer(cx, cy, spriteSize, gripLocal) {
        if (!this._gunMovementFrames() && !['gun_idle', 'gun_idle_pistol', 'gun_idle_dual'].includes(this.state.anim)) return;
        const layer = this._gunLayers?.[this._gunPoseKeyFor()] || this._gunLayers?.gun_idle;
        const arm = layer?.armCfg;
        const image = layer?.arm;
        if (!arm || !image?.complete || !image.naturalWidth || !gripLocal) return;

        const bob = this._gunMovementBob(spriteSize);
        const facingRight = this.state.facingRight !== false;
        const torsoBobX = facingRight ? bob.x : -bob.x;
        const torsoShiftX = facingRight ? layer.torsoShiftX : -layer.torsoShiftX;
        const frameW = 512;
        const frameH = 516;
        const shoulderX = cx - spriteSize / 2
            + (arm.pivotX / frameW) * spriteSize + torsoShiftX + torsoBobX;
        const shoulderY = cy - spriteSize / 2
            + (arm.pivotY / frameH) * spriteSize + layer.torsoShiftY + bob.y;
        const gripX = cx + gripLocal.x;
        const gripY = cy + gripLocal.y;
        const natural = Math.atan2(arm.handY - arm.pivotY, arm.handX - arm.pivotX);
        const naturalEff = facingRight ? natural : Math.PI - natural;
        const aim = Math.atan2(gripY - shoulderY, gripX - shoulderX);

        const ctx = this._ctx;
        ctx.save();
        ctx.translate(shoulderX, shoulderY);
        ctx.rotate(aim - naturalEff);
        if (!facingRight) ctx.scale(-1, 1);
        ctx.drawImage(
            image,
            -(arm.pivotX / frameW) * spriteSize,
            -(arm.pivotY / frameH) * spriteSize,
            spriteSize,
            spriteSize,
        );
        ctx.restore();
    ...
    _drawSwordComboPart([page, name], cx, cy, spriteSize, dash = false) {
        const entry = (dash ? SWORD_DASH_ATLASES : SWORD_COMBO_ATLASES)[page].frames[name];
        const rect = entry.frame, trim = entry.spriteSourceSize, source = entry.sourceSize;
        this._ctx.drawImage((dash ? this._swordDashImages : this._swordComboImages)[page], rect.x, rect.y, rect.w, rect.h,
            cx-spriteSize/2+trim.x/source.w*spriteSize, cy-spriteSize/2+trim.y/source.h*spriteSize,
            trim.w/source.w*spriteSize, trim.h/source.h*spriteSize);
    },

    _drawSwordWalkPart(name, cx, cy, spriteSize) {
        const entry = swordWalkAtlas.frames[name];
        const rect = entry.frame, trim = entry.spriteSourceSize, source = entry.sourceSize;
        this._ctx.drawImage(this._swordWalkImage, rect.x, rect.y, rect.w, rect.h,
            cx-spriteSize/2+trim.x/source.w*spriteSize,
            cy-spriteSize/2+trim.y/source.h*spriteSize,
            trim.w/source.w*spriteSize, trim.h/source.h*spriteSize);
    },
    ...
    _draw() {
        ...
        if (isReady) {
            const currentAnim = this.state.anim;
            // 持枪移动：走/跑腿层 + 躯干 bob 合成预览（与游戏内分层一致）。
            ...
            const gunMovementFrames = this._gunMovementFrames(currentAnim);
            const isGunIdlePose = ['gun_idle', 'gun_idle_pistol', 'gun_idle_dual'].includes(currentAnim);
            const gunLayerReady = isGunWeaponSel && gunLayer && (
                (gunMovementFrames?.sheet.complete && gunMovementFrames.sheet.naturalWidth > 0)
                || (isGunIdlePose && gunLayer.idleLegs?.complete && gunLayer.idleLegs.naturalWidth > 0)
            );
            if (gunLayerReady) {
                ctx.save();
                if (this.state.facingRight === false) {
                ...
                if (gunMovementFrames) {
                    const gf = gunMovementFrames;
                ...
                if (gunLayer.torso && gunLayer.torso.complete && gunLayer.torso.naturalWidth > 0) {
                    ...
                    ctx.drawImage(
                        gunLayer.torso,
                        cx - spriteSize/2 + gunLayer.torsoShiftX + bob.x,
                        cy - spriteSize/2 + gunLayer.torsoShiftY + bob.y,
                        spriteSize,
                        spriteSize,
                    );
                }
                ...
                if (this._isSwordGripAnim(currentAnim)) {
                    idx = this._gripPreviewFrame(currentAnim);
                } else if (this._isPerFrameAnim(currentAnim) && perFrame) {
                ...
                const swordWalk = currentAnim === 'walk' && this.state.weaponType !== 'staff'
                    && this._configKeyOf(this.state.weaponType) === 'sword'
                    && this._swordWalkImage?.complete && this._swordWalkImage.naturalWidth > 0
                    && swordWalkAtlas.frames[`body-${idx}`];
                const swordDash = currentAnim === 'dash';
                const comboPose = this._isSwordGripAnim(currentAnim)
                    ? (swordDash ? dashSlashGrip.poses.attack[idx] : swordComboGrip.poses[this.PANEL_ANIM_TO_CONFIG[currentAnim]]?.[idx]) : null;
                const comboReady = comboPose && (swordDash ? this._swordDashImages : this._swordComboImages)?.every(im => im.complete && im.naturalWidth > 0);
                if (comboReady) {
                    const displaySize = spriteSize*(swordDash ? 1 : swordComboGrip.displayScale);
                    this._drawSwordComboPart(comboPose.body, cx, cy, displaySize, swordDash);
                    this._pendingHandLayer = { comboFrame: comboPose.hand, displaySize, dash: swordDash };
                } else if (swordWalk) {
                    this._drawSwordWalkPart(`body-${idx}`, cx, cy, spriteSize);
                    this._pendingHandLayer = { atlasFrame: `hand-${idx}` };
                } else {
                    const bodySheet = (frameData.handLayer && frameData.handLayer.body.complete && frameData.handLayer.body.naturalWidth > 0)
                        ...
                        : frameData.sheet;
                    ctx.drawImage(bodySheet, sx, sy, frameData.frameW, frameData.frameH,
                        cx - spriteSize/2, cy - spriteSize/2, spriteSize, spriteSize);
                ...
                // 单帧图（待机，或未配置素材的姿态回退）
                const swordIdle = currentAnim === 'idle' && this.state.weaponType !== 'staff'
                    && this._configKeyOf(this.state.weaponType) === 'sword'
                    && this._swordWalkImage?.complete && this._swordWalkImage.naturalWidth > 0;
                if (swordIdle) {
                    this._drawSwordWalkPart(swordWalkGrip.idle.body, cx, cy, spriteSize);
                    this._pendingHandLayer = { atlasFrame: swordWalkGrip.idle.hand };
                } else {
        ...
        if (this.state.weaponOnCanvas && this.weaponImage && this.weaponImage.complete) {
            ...
            if ((this._isPerFrameAnim(this.state.anim) || this.state.anim === 'walk' || isCastAnim) && (isMelee || isCastAnim)) {
                ...
                // 显示轨迹独立，判定/音效标记仍读原战斗段。
                const block = WeaponAnimConfig[wtKey] && WeaponAnimConfig[wtKey][this._isSwordGripAnim(currentAnim) ? currentAnim : cfgKey];
                const marks = [];
            ...
            local = this._applyDualPreviewOffset(local);
            const mirrored = this._mirrorForFacing(local, rotation);
            local = mirrored.local;
            rotation = mirrored.rotation;

            // 双持姿态先绘制副手；使用与主手完全相同的真实纹理宽高比和逐贴图抓握点。
            const offhandDrawState = isGun ? this._getOffhandWeaponDrawState() : null;
            if (offhandDrawState) {
                const oh = offhandDrawState.local;
                const ohScale = oh.scale || 1;
                const ohHeight = s * 0.5 * ohScale;
                const ohWidth = ohHeight * ((this.weaponImage.naturalWidth || 1) / Math.max(1, this.weaponImage.naturalHeight || 1));
                const ohGrip = WeaponTransform.getTextureGrip(
                    wtKey,
                    this._textureKeyOf(),
                    { width: ohWidth, height: ohHeight }
                );
                ctx.save();
                ctx.translate(cx + oh.x, cy + oh.y);
                ctx.rotate(offhandDrawState.rotation);
                if (this.state.facingRight === false) ctx.scale(1, -1);
                ctx.drawImage(this.weaponImage, -ohGrip.x * ohWidth, -ohGrip.y * ohHeight, ohWidth, ohHeight);
            ...
            ctx.rotate(rotation);
            // 朝左：近战沿用 flipX；枪械与运行时 Phaser Sprite 一致使用 flipY，
            // 否则抓握点的贴图内 Y 镜像方向会与实机相反。
            if (this.state.facingRight === false) {
                if (isGun) ctx.scale(1, -1);
                else ctx.scale(-1, 1);
            }
            ...
            if (isMelee) {
                ...
                const w = h * ((this.weaponImage.naturalWidth || 1) / Math.max(1, this.weaponImage.naturalHeight || 1)) * stX;
                // 逐贴图抓握点 + 源图宽高比：与 GameScene 的 setScale(height/sourceHeight) 同口径。
                const grip = WeaponTransform.getTextureGrip(
                    wtKey,
                    this._textureKeyOf(),
                    { width: w, height: h }
            ...
            // 持枪手臂条在武器之上，手点按运行时 IK 公式追随同一个 grip origin。
            if (isGun) this._drawGunArmLayer(cx, cy, spriteSize, local);

            // 手部分层：武器绘制完成后叠回手层（与游戏 depth：身体 < 武器 < 手 一致）
            this._drawHandLayer(cx, cy, spriteSize);

            // 渲染字段提示：spriteOffset/rotOffset 已叠加进预览（所见即所得）；
            // aimSpriteOffset 仍依赖瞄准过渡；dualOffsetX/副手与 bobWeaponScale 已按当前姿态模拟。
            ...
            if (renderOff.dualOffsetX && !this._isDualGunPreview()) extras.push(`dualOffsetX=${renderOff.dualOffsetX}(仅双持)`);
            if (renderOff.bobWeaponScale !== 1 && !this._gunMovementFrames()) extras.push(`bobScale=${renderOff.bobWeaponScale}`);
    ...
    _showToast(message) {
        ...
        toast.className = 'dev-tool-toast';
    ...
    show() {
        ...
        this._draw();
        this._panel?.querySelector('.dev-tool-tab.active')?.focus({ preventScroll: true });
    },
    ...
    _loadFromGamePlayer() {
        ...
        const runtimeGunPose = resolveGunPose(player);
        this.state.gunPoseKey = runtimeGunPose?.poseKey || null;
        this._syncGunPoseSelect();
        ...
        if (scene && scene.playerSprite && scene.playerSprite.anims && scene.playerSprite.anims.currentAnim) {
            ...
            if (key.endsWith('_walklegs')) cfgKey = 'walk';
            else if (key.endsWith('_runlegs')) cfgKey = 'run';
            else if (key.startsWith('player_')) cfgKey = key.slice('player_'.length);
        }
    ...
    hide() {
        const restoreFocus = this._panel?.contains(document.activeElement);
        this._active = false;
        ...
        if (restoreFocus) {
            const target = this._returnFocus?.isConnected && this._returnFocus !== document.body ? this._returnFocus : trigger;
