...
export function createHudPanelsExpeditionQuestReward() {
    ...
    rewardPanelSubtitle.setAttribute('role', 'status');
    rewardPanelSubtitle.setAttribute('aria-live', 'polite');
    ...
    rewardCardsContainer.setAttribute('aria-label', '三选一额外奖励');
    const rewardSummary = document.createElement('div');
    rewardSummary.id = 'rewardGuaranteedSummary';
    rewardSummary.className = 'reward-guaranteed-summary';
    const rewardFooter = document.createElement('footer');
    rewardFooter.className = 'reward-panel-footer';
    const rewardHint = document.createElement('p');
    rewardHint.id = 'rewardPanelHint';
    const rewardContinue = document.createElement('button');
    rewardContinue.id = 'rewardContinueBtn';
    rewardContinue.className = 'bp-button reward-continue-button';
    rewardContinue.type = 'button';
    rewardContinue.textContent = '继续结算';
    rewardContinue.hidden = true;
    rewardFooter.append(rewardHint, rewardContinue);
    ...
    rewardPanelShell.appendChild(rewardSummary);
    rewardPanelShell.appendChild(rewardCardsContainer);
    rewardPanelShell.appendChild(rewardFooter);
