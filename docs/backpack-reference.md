...
字体外观校准：保持装备名称16px、背包物品名12px；SimHei常规字体增加合成加粗（空槽0.3、已装备与背包物品0.9），近似源CSS的600/700字重。根据1912×948参考图调整名称约2px的位置偏差。该参数是Godot视觉校准值，并非CSS字重的数值换算。已重新渲染两档分辨率并完成180帧无头验证。
