...
assets=create('DA_TemperateHillsStreaming',u.TemperateHillsAssets,factory)
...
hill.set_editor_property('detail_radius_meters',160)
hill.set_editor_property('view_radius_meters',384)
