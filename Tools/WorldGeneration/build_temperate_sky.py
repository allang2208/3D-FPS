...
# Coverage adds to the cloud layout. Density multiplies the shaped extinction
# field and must remain nonzero even on a clear day.
scalars = {'Cloud_GlobalCoverage': -.18, 'Cloud_GlobalDensity': .008, 'StormClouds': 0}
