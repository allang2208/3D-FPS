...
r=Path('D:/FPS3D/FPSGAME/SourceAssets/HandBrain20260910/surface_v07');lib=unreal.EditorAssetLibrary
mesh=unreal.load_asset('/Game/Monsters/HandBrain/SurfaceV07/SK_HandBrain_Surface');clip=unreal.load_asset('/Game/Monsters/HandBrain/SurfaceV07/A_HandBrain_Howl_Surface');assert mesh and clip
assert all('/SurfaceV07/' in s.material_interface.get_path_name() for s in mesh.get_editor_property('materials'))
