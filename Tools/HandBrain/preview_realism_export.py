...
bpy.ops.import_scene.fbx(filepath=str(r/'A_HandBrain_Howl_Realism.fbx'))
rig=next(o for o in bpy.data.objects if o.type=='ARMATURE');mesh=next(o for o in bpy.data.objects if o.type=='MESH')
names=['Baked_HandBrain_Body_0','Baked_HandBrain_Body_1','Baked_HandBrain_Body_2','Baked_HandBrain_AttackArm_0','Baked_HandBrain_CrownHands_0','Baked_HandBrain_OralTeeth_0']
