...
r=Path('D:/FPS3D/FPSGAME/SourceAssets/HandBrain20260910/surface_v07');dest='/Game/Monsters/HandBrain/SurfaceV07';lib=unreal.EditorAssetLibrary
...
mesh=load('SK_HandBrain_Surface.fbx','SK_HandBrain_Surface',o)
...
clip=load('A_HandBrain_Howl_Surface.fbx','A_HandBrain_Howl_Surface',o);assert abs(clip.get_play_length()-3)<.04
