...
r=Path('D:/FPS3D/FPSGAME/SourceAssets/HandBrain20260910/sculpt_v06');lib=unreal.EditorAssetLibrary
mesh=unreal.load_asset('/Game/Monsters/HandBrain/SculptV06/SK_HandBrain_Sculpt');clip=unreal.load_asset('/Game/Monsters/HandBrain/SculptV06/A_HandBrain_Howl_Sculpt');assert mesh and clip
assert all('/SculptV06/' in s.material_interface.get_path_name() for s in mesh.get_editor_property('materials'))
