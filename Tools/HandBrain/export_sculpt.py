...
bpy.ops.export_scene.fbx(filepath=str(r/'SK_HandBrain_Sculpt.fbx'),bake_anim=False,**kw)
...
bpy.ops.export_scene.fbx(filepath=str(r/'A_HandBrain_Howl_Sculpt.fbx'),bake_anim=True,**kw)
