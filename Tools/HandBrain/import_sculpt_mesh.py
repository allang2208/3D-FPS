...
r=Path('D:/FPS3D/FPSGAME/SourceAssets/HandBrain20260910/sculpt_v06');dest='/Game/Monsters/HandBrain/SculptV06';lib=unreal.EditorAssetLibrary
...
mesh=load('SK_HandBrain_Sculpt.fbx','SK_HandBrain_Sculpt',o)
...
clip=load('A_HandBrain_Howl_Sculpt.fbx','A_HandBrain_Howl_Sculpt',o);assert abs(clip.get_play_length()-3)<.04
