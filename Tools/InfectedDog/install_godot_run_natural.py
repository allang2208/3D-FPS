"""Install the natural-run polish, retaining the current rig and other actions."""
...
ROOT=Path('D:/FPS3D/FPSGAME/SourceAssets/InfectedDogMeshy20260924/GodotRunNaturalV3')
...
report=install_run(ROOT=ROOT,DEST='/Game/Monsters/InfectedDog/MeshyV2/GodotRunNaturalV3',
                   NAME='A_InfectedDogMeshy_GodotRunNaturalV3',REVISION='GodotCanineNaturalV3-20260924')
report['offline_diagnostic_rendered']=False
report['preview_rendered']=False
