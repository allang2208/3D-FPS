...
int32 UColdSteelInventoryWidget::NativePaint(const FPaintArgs& A,const FGeometry& G,const FSlateRect& C,FSlateWindowElementList& Out,int32 Layer,const FWidgetStyle& S,bool Enabled)const
{
    ...
    const bool Gun=Selection&&(Selection->Definition==TEXT("ue_m4a1")||Selection->Definition==TEXT("ue_akm")||Selection->Definition==TEXT("ue_qbz191")||(Selection->Definition==TEXT("ue_m1911")||Selection->Definition==TEXT("ue_dan_wesson715")));
