...
void UColdSteelInventoryWidget::PerformAction(int32 Action)
{
    ...
    if(Action==7)if(const auto* I=Model->FindItem(Selected))if((I->Definition==TEXT("ue_m4a1")||I->Definition==TEXT("ue_akm")||I->Definition==TEXT("ue_qbz191")||I->Definition==TEXT("ue_m1911")))
