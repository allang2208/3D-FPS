...
int32 UColdSteelWeaponIconCatalogCommandlet::Main(const FString& Params)
{
    ...
    const TArray<FString> Definitions=Requested.IsEmpty()?TArray<FString>{TEXT("ue_m1911"),TEXT("ue_akm"),TEXT("ue_a762"),TEXT("ue_m4a1"),TEXT("ue_m16a2"),TEXT("ue_ash12"),TEXT("ue_dan_wesson715"),TEXT("ue_rune_sword")}:TArray<FString>{Requested};
