...
- [M4 枪托砸击（2026-09-18 暂停待办）](Docs/Weapons/m4-stock-melee-20260918.md)：步枪版快速进战；作者源 clip（整枪搬运写在 `WPN_` 骨、双手随握把关系）+ Blender 对位预览，命中探针取枪身前段。只做 M4；横向横扫方向已对齐，幅度/节奏待下次真机比对。
- [本轮整理与发布](Docs/Weapons/melee-publication-20260914.md)；[仓库规则](WORKFLOW.md#8-仓库整理与推送)。

**格挡动作 V18/V19 均未达到用户预期，2026-09-14 暂停。当前安装动作仅为继续工作入口，不是已接受标准。** 本轮不继续调动画；默认不启动游戏测试或渲染，由用户决定下次继续的范围。
