...
# 与 scripts/wolf_rig.gd BONE_DEFS / SKIN_SEGS 保持一致（模型空间，wolf-inspect 实测）
BONES = [
    ("pelvis", (0, 0.06, -0.22)), ("spineMid", (0, 0.09, -0.05)), ("chest", (0, 0.10, 0.10)),
    ("neck", (0, 0.15, 0.24)), ("head", (0, 0.19, 0.33)), ("tail", (0, 0.05, -0.32)),
    ("FLRoot", (-0.075, 0.01, 0.17)), ("FLKnee", (-0.075, -0.09, 0.15)), ("FLPaw", (-0.063, -0.21, 0.19)),
    ("FRRoot", (0.085, 0.01, 0.14)), ("FRKnee", (0.085, -0.09, 0.12)), ("FRPaw", (0.078, -0.18, 0.15)),
    ("HLRoot", (-0.10, 0.02, -0.29)), ("HLKnee", (-0.10, -0.08, -0.30)), ("HLPaw", (-0.103, -0.19, -0.32)),
    ("HRRoot", (0.07, 0.02, -0.28)), ("HRKnee", (0.07, -0.08, -0.29)), ("HRPaw", (0.051, -0.20, -0.27)),
]
