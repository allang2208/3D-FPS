extends SceneTree
const OUT="E:/3d/3-dfps/tools/ai-gen/black-wolf-fur-v01-20260906/rendered"
...
func render_all() -> void:
	...
	camera.size=1.4
	for version in ["source","wolf"]:
		var file="res://source.gltf" if version=="source" else "res://wolf.glb"
		...
		if version=="wolf":
			...
			await snap(folder.path_join("fur-detail.png"))
		...
		model.queue_free()
		await process_frame
	print("BLACK_WOLF_RENDER_COMPLETE: existing clips, default D3D12 Forward+, fixed review lights")
	quit()
