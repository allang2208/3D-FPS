...
func run():
 ...
 var model=load("res://tools/ai-gen/foreman-attack-v06-20260906/foreman-attack-v06.glb").instantiate();model.name="Model";enemy.add_child(model);enemy.transform=tr;world.add_child(enemy);enemy.set_physics_process(false)
