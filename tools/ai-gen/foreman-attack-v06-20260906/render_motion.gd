extends SceneTree
var OUT := "res://tools/ai-gen/foreman-attack-v06-20260906/runtime"
...
func run_render() -> void:
	...
	if not OS.get_cmdline_user_args().has("--formal"):
		...
		var model=load("res://tools/ai-gen/foreman-attack-v06-20260906/foreman-attack-v06.glb").instantiate()
		model.name="Model"
