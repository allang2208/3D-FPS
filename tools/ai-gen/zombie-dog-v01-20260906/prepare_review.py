...
P=Path('E:/3d/zombie-dog-preview-20260906');P.mkdir(exist_ok=True)
shutil.copy2(R.parents[2]/'assets/models/wolf_quaternius.gltf',P/'source.gltf')
if (R/'zombie-dog-v01.glb').exists():shutil.copy2(R/'zombie-dog-v01.glb',P/'zombie.glb')
shutil.copy2(R/'render_review.gd',P/'render_review.gd')
(P/'project.godot').write_text('''config_version=5
[application]
config/name="Zombie dog material review"
...
''',encoding='utf-8')
print('ZOMBIE_DOG_PREVIEW_READY',P)
