extends SceneTree
const OUT := "res://tools/ai-gen/foreman-skin-v05-20260906/runtime"
...
func run_render() -> void:
	...
	if not OS.get_cmdline_user_args().has("--formal"):
		...
		var model=load("res://tools/ai-gen/foreman-skin-v05-20260906/foreman-skin-v05.glb").instantiate()
		model.name="Model"
