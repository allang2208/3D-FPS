...
bpy.ops.import_scene.gltf(filepath=str(R/'denys-A-motions.gltf'))
...
bpy.ops.import_scene.gltf(filepath=str(R/'ual-mannequin.glb'))
...
bpy.ops.wm.save_as_mainfile(filepath=str(R/'modern-zombie-v01.blend'))
bpy.ops.export_scene.gltf(filepath=str(R/'modern-zombie-v01.glb'),export_format='GLB',use_selection=True,export_animations=True,export_animation_mode='ACTIONS',export_frame_range=False,export_force_sampling=True,export_frame_step=1,export_def_bones=False)
