...
R=Path('E:\\3d\\3-dfps\\tools\\ai-gen\\humanoid-variants-v01-20260906\\miner'); SOURCE=Path('E:\\3d\\3-dfps\\tools\\ai-gen\\modern-zombie-v01-20260906')
...
def alias(original,name,speed=1):
 ...
 return act
alias('idle_220f','Idle');alias('slowWalk_85f','Walk')
