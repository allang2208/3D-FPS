extends SceneTree
var OUT := "res://tools/ai-gen/foreman-downstroke-v07-20260906/runtime"
func _initialize() -> void:
	if OS.get_cmdline_user_args().has("--review-light"):OUT+="-lit"
	if OS.get_cmdline_user_args().has("--detail"):OUT="res://tools/ai-gen/foreman-downstroke-v07-20260906/runtime-detail"
...
func run_render() -> void:
	...
	if not OS.get_cmdline_user_args().has("--formal"):
		...
		var model=load("res://tools/ai-gen/foreman-downstroke-v07-20260906/foreman-downstroke-v07.glb").instantiate()
		model.name="Model"
