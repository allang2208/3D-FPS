extends SceneTree
const OUT="E:/3d/3-dfps/tools/ai-gen/humanoid-variants-v01-20260906/rendered"
...
func render_all() -> void:
	...
	for version in versions:
		...
		if version in ["miner","runner"]:clips=["Idle","Walk","Attack","AttackRight","Death","HitReact"]
