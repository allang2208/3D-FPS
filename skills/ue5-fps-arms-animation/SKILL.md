...
- 双手剑、双手近战挥砍/重击/突刺和格挡，或手腕扭转、左右臂交叉：[双手近战动作](references/two-handed-melee.md)。固定双手握点、分离剑身展示角与攻击刃向；符文剑 V21 格挡与 V22 蓄力左臂已获用户接受。2026-09-25 的 V53 剑面检视已被否定并退回；同日按 BV1zz4y117f6 正向转刀接入 V54，V55 因改手部姿态被否定，现已接入 V59（V54 手剑姿态 + 右臂摆动支撑 + 转剑 0.33 s + recover 回待机），尚未经用户试玩判定。
