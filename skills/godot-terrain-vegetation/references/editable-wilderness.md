...
- 本例测试：`test_voxel_lab`、`test_smooth_voxel`、`test_wilderness_world`、`test_wilderness_scene`、`test_scenic_valley`；覆盖材料守恒、撤销/保存/恢复、共享法线、坡地和边界射线、植被遮罩、武器切换、Terrain3D 建筑锚点及采集事务。
