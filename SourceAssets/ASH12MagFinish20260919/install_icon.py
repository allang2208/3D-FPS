...
keys=['ue_ash12_magazine_ext_mag']
for key in keys:
 ...
 E.set_metadata_tag(tex,'AttachmentIconRule','Front-left; gun-up; horizontal orthographic; ASH12 corrected regional material mask; transparent 1024 RGBA')
