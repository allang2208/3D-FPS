# Import the aimed-up (v2) AKM / A762 reload clips through a headless UE commandlet.
$ErrorActionPreference = 'Stop'
$root = 'D:\FPS3D\FPSGAME'
$engine = 'E:\Program Files (x86)\UE_5.8\Engine\Binaries\Win64\UnrealEditor-Cmd.exe'
$script = Join-Path $PSScriptRoot 'install2.py'
$log = Join-Path $PSScriptRoot 'ue-import2.log'
