...
(thumb_target4.json reproduces the round-1 receipt exactly) - and only replaces
...
for job in SOURCES:
    ...
    (O / 'authoring4.json').write_text(json.dumps(receipt, indent=1), encoding='utf-8')
