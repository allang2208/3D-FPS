...
O=Path(__file__).parent;bpy.ops.wm.open_mainfile(filepath=str(O/'M4_DrumMatch_Editable.blend'));r=bpy.data.objects['SK_M4_Infima'];s=bpy.context.scene;out={}
for clip,end in [('reload',126),('reload_empty',148)]:
 a=bpy.data.actions['A_M4_DrumMatch_'+clip];r.animation_data.action=a;r.animation_data.action_slot=a.slots[0];prev={};steps=[]
