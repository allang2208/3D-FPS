...
inline constexpr FKey Empty[] = {
    {0.000000000f, 0.000000000f},
    {32.400000000f, 0.130000000f},
    {43.000000000f, 0.213607682f},
    {61.560000000f, 0.311202561f},
    {80.000000000f, 0.412382259f},
    {90.720000000f, 0.500612711f},
    {111.000000000f, 0.672742341f},
...
{
    return bEmpty ? Evaluate(Empty,Fraction,EmptyDurationScale) : Evaluate(Normal,Fraction,NormalDurationScale);
}
}
