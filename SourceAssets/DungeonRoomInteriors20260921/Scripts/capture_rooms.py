...
OUT=Path('D:/FPS3D/FPSGAME/Docs/Gameplay/Previews/DungeonRoomInteriors20260921')
OUT.mkdir(parents=True,exist_ok=True)
STATE=ROOT/'Receipts/room-capture-state.json'
TARGET='/Game/GameMaps/L_Dungeon_Prototype'
VIEWS=[
    ('01_workshop_entrance',[725,-65,165],[720,290,145],86),
    ('02_workshop_bench',[790,130,157],[941,278,119],70),
    ('03_ruin_entrance',[1810,-320,165],[1900,-950,145],82),
    ('04_ruin_floor_bank',[1870,-640,135],[1620,-835,50],74),
]
...
old=getattr(u,'_dungeon_rooms_capture_job',None)
if old:
    ...
    u._dungeon_rooms_capture_job=None
...
class CaptureJob:
    ...
    def prepare(self):
        ...
        self.actor.set_actor_label('DGN_Room_TransientCapture_'+name)
    ...
    def end(self,status,error=None):
        ...
        try:self.release_view()
            ...
            self.write(status,error);u._dungeon_rooms_capture_job=None
        print('ROOM_CAPTURE_'+status.upper())
    def tick(self,delta):
        try:
...
try:
    job=CaptureJob();u._dungeon_rooms_capture_job=job
