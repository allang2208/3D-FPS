...
void AFPSGAMECharacter::InitializeWeaponVisuals()
{
    ...
    USkeletalMesh* ViewmodelMesh = LoadObject<USkeletalMesh>(nullptr, TEXT("/Game/Weapons/AKMIntegration/Materials/SK_AKM_MannyNative.SK_AKM_MannyNative"), nullptr, LOAD_NoWarn);
    ...
    DrumReloadAnimation=LoadObject<UAnimSequence>(nullptr,TEXT("/Game/Weapons/M4DrumDrop/Match/A_M4_DrumMatch_reload.A_M4_DrumMatch_reload"));
    DrumReloadEmptyAnimation=LoadObject<UAnimSequence>(nullptr,TEXT("/Game/Weapons/M4DrumDrop/Match/A_M4_DrumMatch_reload_empty.A_M4_DrumMatch_reload_empty"));
    ...
    if (bHit && Hit.GetActor())
    {
        ...
        if(!bLastShotMuzzleBlocked&&ProjectileSpeedCM<=0){
            ...
            while(Remaining-->0&&Cast<APawn>(NextHit.GetActor())){
                ...
                if(NextHit.GetActor())UGameplayStatics::ApplyPointDamage(NextHit.GetActor(),DamagePerShot,TraceDirection,NextHit,Controller,this,nullptr);
