...
void AFPSGAMECharacter::RunDrumGripAudit()
{
    ...
    if(DrumGripAuditStage==0)
    {
        ...
        Check(DrumReloadAnimation&&DrumReloadAnimation->GetPathName().Contains(TEXT("/M4DrumDrop/Match/"))&&DrumReloadEmptyAnimation&&DrumReloadEmptyAnimation->GetPathName().Contains(TEXT("/M4DrumDrop/Match/")),TEXT("revision 7 reload default clips loaded"));
