...
bpy.ops.import_scene.fbx(filepath=r'D:\FPS3D\FPSGAME\Content\m4noskel.fbx')
...
(OUT/'m4_source_source_inspection.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'m4_source_imported.blend'))
...
for name,offset in [('side_x',(1,0,.12)),('side_y',(0,-1,.1)),('top',(0,0,1))]:
    ...
    scene.render.filepath=str(OUT/('m4_source_source_'+name+'.png'))
