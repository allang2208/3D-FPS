...
bpy.ops.wm.open_mainfile(filepath=str(OUT/'SK_M4_Candidate_Source.blend'))
...
def render(name):
    scene.render.filepath=str(OUT/('m4_fit_'+name+'.png'));bpy.ops.render.render(write_still=True)
def center():
