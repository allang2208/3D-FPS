...
if '--full' in sys.argv:
 ...
 for clip,end in [('reload',126),('reload_empty',162),('drum_reload',126),('drum_reload_empty',148)]:checks.append((clip,sorted(set([k/4 for k in range(113 if clip.startswith('drum') else 65)]+[k/4 for k in range((end-24)*4,end*4+1)]+[43,54,76,80,95]))))
