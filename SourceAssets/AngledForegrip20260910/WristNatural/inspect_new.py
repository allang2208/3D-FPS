...
O=Path(__file__).parent;P=O;bpy.ops.wm.open_mainfile(filepath=str(P/'A_M4_Foregrip_idle.blend'));r=bpy.data.objects['SK_M4_Infima'];bpy.context.scene.frame_set(0);bpy.context.view_layer.update()
