...
code="@(Get-ChildItem -LiteralPath 'D:/开发文件/ComfyUI/output/LPVO1to6X20260911' -Filter '*.glb' | ForEach-Object { @{name=$_.Name;bytes=$_.Length;sha256=(Get-FileHash -LiteralPath $_.FullName).Hash} }) | ConvertTo-Json -Compress"
