...
keys=['ue_m4a1_magazine_ext_mag','ue_akm_magazine_ext_mag','ue_qbz191_magazine_ext_mag','magazine_ext_mag']
for key in keys:
 ...
 E.set_metadata_tag(tex,'AttachmentIconRule','Front-left; gun-up; horizontal orthographic; current ExtMagContinuity model; transparent 1024 RGBA')
