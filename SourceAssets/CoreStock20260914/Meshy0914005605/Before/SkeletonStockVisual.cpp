...
void AFPSGAMECharacter::SetGunsmithStock(const FString& Variant)
{
    ...
    const bool Enabled=(Variant==TEXT("skeleton")||QR||Core)&&(bUsingM4Infima||AKM||bUseQBZ191)&&bInventoryWeaponReady;
    ...
    if(Enabled)
    {
        ...
        if(QR)
            ...
            StockPath=AKM?TEXT("/Game/Weapons/CoreStock20260914/AKM/SM_CoreStock.SM_CoreStock"):TEXT("/Game/Weapons/CoreStock20260914/M4/SM_CoreStock.SM_CoreStock");
