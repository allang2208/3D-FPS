...
void AFPSGAMECharacter::SetGunsmithStock(const FString& Variant)
{
    ...
    if(Enabled)
    {
        const TCHAR* StockPath=QR
            ...
            :(AKM?TEXT("/Game/Weapons/ReferenceStock5080/Refined91379/AKM/SM_SkeletonStock.SM_SkeletonStock"):TEXT("/Game/Weapons/ReferenceStock5080/Refined91379/M4/SM_SkeletonStock.SM_SkeletonStock"));
