...
bpy.ops.import_scene.gltf(filepath=str(root / 'handbrain_hunyuan_v01.glb'))
...
bpy.ops.export_scene.fbx(filepath=str(root/'handbrain_hunyuan_v01.fbx'), use_selection=True, path_mode='COPY', embed_textures=True, add_leaf_bones=False)
bpy.ops.export_scene.gltf(filepath=str(root/'handbrain_hunyuan_v01_clean.glb'), use_selection=True, export_format='GLB')
...
bpy.ops.wm.save_as_mainfile(filepath=str(root/'handbrain_hunyuan_v01.blend'))
