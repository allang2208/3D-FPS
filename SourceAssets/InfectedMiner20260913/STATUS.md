...
当前 Attack 为 `OuterSwing/`：替换穿过躯干的回转路径，改成外侧抬镐、上方前挥及外侧收回。Idle/Walk 沿用 `NaturalWrist`，人物与放大后的矿镐沿用 `DragGround`。见 [当前攻击说明](../../Docs/InfectedMinerOuterSwing20260913.md)。未进行游戏测试；以下是历史阶段记录。
