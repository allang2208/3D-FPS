"""Import the V44 revision into the owning editor when Windows holds the files."""
import runpy
...
try:
    runpy.run_path(str(Path(__file__).with_name('import_revision_v44.py')), run_name='__main__')
finally:
