"""Install the uniformly smaller sword, closed arm clips and matching rift meshes."""
...
(P/'import_receipt.json').write_text(json.dumps(receipt,indent=2));u.log('RUNESWORD_V4_IMPORT_COMPLETE')
