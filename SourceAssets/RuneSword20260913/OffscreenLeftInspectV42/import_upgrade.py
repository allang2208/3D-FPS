"""Import the V42 rune-sword inspection into its existing runtime asset."""
import json
import shutil
...
try:
    ...
    (P / 'import_receipt.json').write_text(json.dumps({
        'revision': 'OffscreenLeftInspectV42',
        ...
        'testing': 'No new playback, render or automated audit requested or performed' 
    }, indent=2), encoding='utf-8')
    u.log('OFFSCREEN_LEFT_V42_IMPORT_COMPLETE')
finally:
