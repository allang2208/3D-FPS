"""Import the V41 rune-sword inspection into its existing runtime asset."""
import json
import shutil
...
try:
    ...
    (P / 'import_receipt.json').write_text(json.dumps({
        ...
        'testing': 'User-requested source and UE asset audits are recorded separately in connection_audit.json and UEAfterV41' 
    }, indent=2), encoding='utf-8')
    u.log('ANCHORED_ARM_FLOW_V41_IMPORT_COMPLETE')
finally:
