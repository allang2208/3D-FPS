...
$gripArgs='"{0}/FPSGAME.uproject" /Game/Weapons/M4InfimaRigV4/Preview/L_M4RigValidation -game -windowed -RenderOffscreen -ResX=1000 -ResY=700 -unattended -nosplash -CantedGripAudit -ForegripRun={1} -ColdSteelProfile=ForegripAudit_{1} -ExecCmds="DisableAllScreenMessages,t.MaxFPS 60" -abslog="{2}/runtime-{1}.log"' -f $gripRoot,$Run,$PSScriptRoot
...
Write-Output "CANTED_GRIP_RUNTIME_PASS $Run"
