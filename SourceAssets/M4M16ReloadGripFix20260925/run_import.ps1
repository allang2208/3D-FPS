# Import the grip-refined M4 / M16 reload clips through a headless UE commandlet.
# Only runs when no FPSGAME editor or commandlet is alive, and it takes the same
# batch mutex the MCP bridge uses so parallel sessions cannot overlap.
...
$log = Join-Path $PSScriptRoot 'ue-import.log'
