"""Import the DW715 quick-combat (grip bash) clip with the existing skeleton."""
...
u.log('DW715_QUICKCOMBAT_IMPORTED %s length=%.4f' % (kind, clip.get_play_length()))

(out / 'import.json').write_text(json.dumps(receipt, indent=2), encoding='utf-8')
u.log('DW715_QUICKCOMBAT_IMPORT_COMPLETE')
