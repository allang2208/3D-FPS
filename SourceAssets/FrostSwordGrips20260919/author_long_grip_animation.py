...
P=Path(__file__).parent;OUT=P/'Animations';OUT.mkdir(exist_ok=True)
...
inputs=json.loads((P/'source_animation_inputs.json').read_text())
...
for info in inputs:
    ...
    (P/'animation_receipt.json').write_text(json.dumps(receipts,indent=2))
