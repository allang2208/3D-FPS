...
out={'hand_in_mag':H.tolist(),'finger_basis':{n:wxyz(q) for n,q in Q.items()},'open_basis':{n:wxyz(q) for n,q in opened.items()},
 ...
 'method':'Current evaluated SVD; local X finger length, local Y abduction, local Z flexion; deeper middle-phalanx wrap; bounded 0.55 mm glove surface compression',
 'game_tested':False}
