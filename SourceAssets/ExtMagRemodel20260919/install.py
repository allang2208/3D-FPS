...
O=Path(__file__).parent;D='/Game/Weapons/ExtMagRemodel20260919';E=u.EditorAssetLibrary;A=u.AssetToolsHelpers.get_asset_tools();report={}
u.SystemLibrary.execute_console_command(None,'Interchange.FeatureFlags.Import.FBX 0')
materials={'M4':'/Game/Weapons/ExtMagContinuity20260919/Materials/M_M4_Continuous','QBZ':'/Game/Weapons/QBZ191/Attachments20260913/Materials/M_QBZ191_Unified_M_QBZ191_Wear_Magazine_polymer'}
for gun,path in materials.items():
 name='SM_ExtMag_'+gun+'40_Remodel';t=u.AssetImportTask();t.filename=str(O/'FBX'/(name+'.fbx'));t.destination_path=D;t.destination_name=name;t.automated=True;t.replace_existing=True;t.save=False
