...
@(Get-ChildItem -LiteralPath 'D:/开发文件/ComfyUI/output/EnhancementMaterials20260911' -Filter '*.glb' -ErrorAction SilentlyContinue | ForEach-Object { @{name=$_.Name;bytes=$_.Length;sha256=(Get-FileHash -LiteralPath $_.FullName -Algorithm SHA256).Hash} }) | ConvertTo-Json -Compress
"""
