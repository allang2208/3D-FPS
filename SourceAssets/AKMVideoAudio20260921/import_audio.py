...
DEST = '/Game/Weapons/AKM/VideoAudio20260921'
receipt = []
for cue in ('Fire', 'MagOut', 'MagInsert', 'MagSeat', 'ChargePull', 'ChargeRelease'):
    name = 'S_AKM_' + cue
    original = u.load_asset('/Game/Weapons/AKM/Audio/' + name)
    if original is None:
...
u.log('AKM_VIDEO_AUDIO_IMPORTED ' + json.dumps(receipt))
