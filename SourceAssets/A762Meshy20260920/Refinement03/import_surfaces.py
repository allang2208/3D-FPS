...
R='/Game/Weapons/A762/Integrated20260920'; P='/Game/Weapons/A762/Refinement03'; PRE='/Game/Weapons/A762/Refinement01'
...
for name in ['SK_A762_Manny','SM_A762_RearSight']:
...
try:
    for name,skeletal in [('SK_A762_Manny',True),('SM_A762_RearSight',False)]:
...
u.log('A762_REFINEMENT03_IMPORTED_AND_SAVED')
