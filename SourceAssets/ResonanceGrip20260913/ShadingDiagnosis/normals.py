...
files={'raw':'seed_91871/raw_00001_.glb','textured':'seed_91871/textured_master_00001_.glb','repaired':'Repaired91871/RepairedMaster.glb','normals':'seed_91871/textured_master_00001_.glb'}
...
if stage=='normals':
 ...
 bm=bmesh.new();bm.from_mesh(ob.data);bmesh.ops.remove_doubles(bm,verts=list(bm.verts),dist=.0000001);bmesh.ops.recalc_face_normals(bm,faces=list(bm.faces));bm.to_mesh(ob.data);bm.free()
 for f in ob.data.polygons:f.use_smooth=True
 ob.data.set_sharp_from_angle(angle=math.radians(35));ob.data.update()
...
for mode in ['flat_color']:
 ...
 if stage=='normals' and mode=='flat_color':bpy.ops.wm.save_as_mainfile(filepath=str(P/'Normals_Diagnostic.blend'))
