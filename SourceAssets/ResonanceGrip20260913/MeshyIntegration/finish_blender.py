...
for family in ['M4','AKM','QBZ191']:
 ...
 for m in ob.data.materials:
  ...
  if 'Polymer' in m.name:
   ...
   norm=sample(P/'T_Resonance_Polymer_Normal.png',True,scale);nm=n.new('ShaderNodeNormalMap');nm.uv_map=ob.data.uv_layers[0].name;l.new(norm.outputs['Color'],nm.inputs['Color']);l.new(nm.outputs[0],bs.inputs['Normal'])
