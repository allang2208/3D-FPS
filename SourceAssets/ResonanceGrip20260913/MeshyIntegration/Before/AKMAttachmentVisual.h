...
inline UStaticMeshComponent* Configure(AActor* Owner,USkeletalMeshComponent* Rifle,UStaticMeshComponent* Part,const TCHAR* Key,bool Enabled,FName Bone=TEXT("WPN_root"))
{
    ...
    const FString MeshPath=FCString::Strcmp(Key,TEXT("angled"))==0?TEXT("/Game/Weapons/ResonanceGrip20260913/Repaired91871/AKM/SM_ResonanceGrip"):(FString(Directory)+Key+(FCString::Strcmp(Key,TEXT("canted"))==0?TEXT("_CompactMount"):TEXT("")));
