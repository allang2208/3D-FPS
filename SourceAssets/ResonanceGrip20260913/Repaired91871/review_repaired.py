...
P=Path('D:/FPS3D/FPSGAME/SourceAssets/ResonanceGrip20260913');O=P/'Repaired91871/Review';O.mkdir(exist_ok=True);report={}
bpy.context.preferences.filepaths.save_version=0
for seed in [91871]:
 bpy.ops.wm.read_factory_settings(use_empty=True);bpy.ops.import_scene.gltf(filepath=str(P/'Repaired91871/RepairedMaster.glb'))
