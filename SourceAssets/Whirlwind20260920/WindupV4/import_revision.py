"""Import V4, keeping the existing background blur material.
...
if not task.imported_object_paths or not clip:raise RuntimeError('V4 animation import failed')
compression=u.load_asset('/Game/Weapons/M4InfimaRigV4/BC_M4Viewmodel')
if compression:clip.set_editor_property('bone_compression_settings',compression)
if not L.save_loaded_asset(clip):raise RuntimeError('V4 animation save failed')
...
u.log('WHIRLWIND_V4_IMPORTED '+clip.get_path_name())
...
u.log('WHIRLWIND_V4_ASSETS_SAVED')
