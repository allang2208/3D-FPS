"""Continuous 0.5 s anticipation; shared velocity at every authored knot.
...
LEAD=shaft((.97,.24,0),(.07,.42,-.18),25)
FOLLOW=shaft((1,.10,0),(.10,.35,-.19),25)
KNOTS=[0,READY_END*.28,READY_END*.68,READY_END,
       READY_END+T['spinSeconds']*.25,SPIN_END,ATTACK_END]
KEYS=[IDLE,COIL,LOADED,HELD,LEAD,FOLLOW,IDLE]
