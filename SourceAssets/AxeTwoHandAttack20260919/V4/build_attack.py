"""Author V4: V3 axe trajectory with a wrist-sparing left shoulder/arm chain.

KayKit's CC0 Slice/Chop are timing references, not retargeted skin or contacts.
H3 grips, right arm and V3 timing stay. The left forearm carries its full skin
...
for clip,duration in [('Swing',.68),('HitRecover',.44)]:
    ...
    print('AXE_V4_EXPORTED '+clip,flush=True)
