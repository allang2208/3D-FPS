...
OUT=Path('D:/FPS3D/FPSGAME/SourceAssets/M4HK416Replica20260910')
bpy.ops.wm.open_mainfile(filepath=str(OUT/'M4_HK416_Adapted_Editable.blend'))
s=bpy.context.scene;r=bpy.data.objects['SK_M4_Infima'];data=json.loads((Path('D:/FPS3D/FPSGAME/SourceAssets/M4Drum20260909')/'build.json').read_text())
...
for source_name,name,end in [('M4_HK416_reload','A_M4_HK416_drum_reload',126),('M4_HK416_reload_empty','A_M4_HK416_drum_reload_empty',162)]:
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'M4_HK416_Drum_Editable.blend'))
