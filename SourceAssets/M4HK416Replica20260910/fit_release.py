...
r=bpy.data.objects['SK_M4_Infima'];s=bpy.context.scene;a=bpy.data.actions['M4_HK416_reload_empty'];r.animation_data.action=a;r.animation_data.action_slot=a.slots[0];s.frame_set(130);bpy.context.view_layer.update()
