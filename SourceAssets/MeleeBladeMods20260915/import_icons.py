...
receipt = {}
for key in ('extended_edge', 'heavy_spine', 'feather_edge'):
    name = 'blade_1_' + key
    ...
    ue.EditorAssetLibrary.set_metadata_tag(texture, 'Source', 'User-requested image_gen illustrative numeric blade upgrade, 2026-09-15; no model change')
...
ue.log('MELEE_BLADE_ICONS_IMPORTED')
