...
for pos in [(-.7,-.3,.8),(.8,.5,.8)]:
 d=bpy.data.lights.new('ReviewAfter','AREA');d.energy=95;d.size=1;o=bpy.data.objects.new('ReviewAfter',d);s.collection.objects.link(o);o.location=pos;o.rotation_euler=(Vector((0,.2,-.1))-o.location).to_track_quat('-Z','Y').to_euler()
...
s.render.engine='BLENDER_EEVEE';s.eevee.taa_render_samples=24;s.render.resolution_x=800;s.render.resolution_y=600;s.render.resolution_percentage=100
continuous='--continuous' in sys.argv
for clip,fs in [('reload',[0,102,107,113]),('reload_empty',[93,119,126,130])]:
