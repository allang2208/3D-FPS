param([ValidateSet('panoramic','scope2x','lpvo','muzzle','holographic')][string]$Kind='panoramic',[string]$Run='v1',[switch]$Reload)
...
$flag=switch($Kind){'holographic'{'-M4GunsmithAudit -AKMOpticAudit'}'panoramic'{'-M4GunsmithAudit -AKMOpticAudit -PanoramicRedDotAudit'}'scope2x'{'-M4GunsmithAudit -AKMOpticAudit -PrismScope2XAudit'}'lpvo'{'-M4GunsmithAudit -AKMOpticAudit -LPVOAudit'}'muzzle'{'-MuzzleMigrationAudit -AKMMuzzleAudit'}}
...
$folder=switch($Kind){'holographic'{'M4GunsmithAudit/AKM'}'panoramic'{'PanoramicRedDotAudit/AKM'}'scope2x'{'PrismScope2XAudit/AKM'}'lpvo'{'LPVOAudit/AKM'}'muzzle'{'AKMMuzzleAudit'}}
