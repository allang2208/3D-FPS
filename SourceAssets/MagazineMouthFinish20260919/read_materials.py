...
O=Path('D:/FPS3D/FPSGAME/SourceAssets/WeaponAttachmentFinish20260913')
S=O.parent
...
Path('D:/FPS3D/FPSGAME/SourceAssets/MagazineMouthFinish20260919/material_sources.json').write_text(json.dumps(report,indent=2))
