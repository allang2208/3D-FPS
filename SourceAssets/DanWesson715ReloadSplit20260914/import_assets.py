"""Import the split tactical/empty reloads and retain the existing weapon skeleton."""
...
receipt={'clips':{},'scope':'21 individual-loading clips and 6 speedloader variants','gameplay_testing':'Not performed; user testing'}
