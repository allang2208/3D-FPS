...
PREFIX = f'ReferenceSuppressor5080_20260913/seed_{SEED}'
...
def submit():
    ...
    body = (f'--{boundary}\r\nContent-Disposition: form-data; name="image"; filename="reference_suppressor_20260913_three_views.png"\r\nContent-Type: image/png\r\n\r\n').encode() + (ROOT / 'three_views.png').read_bytes() + f'\r\n--{boundary}--\r\n'.encode()
    ...
    views = [
        ('side_a', 'front_image', '+Z', (0, 50, 1536, 325)),
        ('side_b', 'back_image', '-Z', (0, 385, 1536, 280)),
        ('front_end', 'left_image', '-X', (620, 675, 300, 300)),
    ]
    mapping = []
    ...
    payload = {'client_id':'ReferenceSuppressor5080_20260913', 'prompt':workflow}
