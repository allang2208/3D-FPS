...
for clip,fs in [('reload',[29,76,95,104,110]),('reload_empty',[21,28,40,54,80,95,101,130]),('equip_charge',[12,18,24])]:
 for version in ['M4_MAT_']:
  a=(bpy.data.actions.get(version+clip+'.001') or bpy.data.actions[version+clip]);r.animation_data.action=a;r.animation_data.action_slot=a.slots[0]
