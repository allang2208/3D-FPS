...
void AFPSGAMECharacter::InitializeWeaponVisuals()
{
    ...
    DrumReloadAnimation=LoadObject<UAnimSequence>(nullptr,TEXT("/Game/Weapons/M4DrumDrop/Flow/A_M4_DrumFlow_reload.A_M4_DrumFlow_reload"));
    DrumReloadEmptyAnimation=LoadObject<UAnimSequence>(nullptr,TEXT("/Game/Weapons/M4DrumDrop/Flow/A_M4_DrumFlow_reload_empty.A_M4_DrumFlow_reload_empty"));
    ...
    if (bUsingM4Infima)
    {
        ...
        if (Clip)
        {
            const FString Path = FString::Printf(TEXT("/Game/Weapons/%s/A_M4_HK416_%s.A_M4_HK416_%s"),
                TEXT("M4WrapGripFinal"), Clip, Clip);
