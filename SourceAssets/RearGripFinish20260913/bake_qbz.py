 ...
 for m in original:
  ...
  for nd in m.node_tree.nodes:
   if nd.type=='TEX_IMAGE' and nd.image:
    ...
    src=O/('T_Balanced_'+kindtex+'.png') if info['kind']=='balanced' else O.parent/'PhantomRearGripIntegration20260913'/('T_PhantomRearGrip_'+kindtex+'.png')
...
bpy.ops.file.pack_all();bpy.ops.wm.save_as_mainfile(filepath=str(O/'QBZ191_RearGripCoating_Editable.blend'));print('QBZ_COATING_BAKE_COMPLETE',flush=True)
