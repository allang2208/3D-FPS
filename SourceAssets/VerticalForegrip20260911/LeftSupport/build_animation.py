...
"""+source[end:]
source=source.replace("   A=old[un].translation.copy();target=H.translation;", "   support_offset=Vector((0.02534833550453186, 0.1502978503704071, -0.18595784902572632))*w\n   p['clavicle_l'].translation+=support_offset\n   A=old[un].translation+support_offset;target=H.translation;")
source=source.replace("   natural=target-desired*l2-A;","   support_direction=(old['WPN_root']@Matrix(fit['grip_in_root'])).to_3x3()@Vector((0.842151939868927, -0.3368607759475708, 0.4210759699344635));desired=desired.lerp(support_direction,w).normalized()\n   natural=target-desired*l2-A;")
