...
files=[P/'VerticalForegrip_Refined.glb'];assert files,'No generated textured model'
...
(P/'refined_inspection.json').write_text(json.dumps(report,indent=2))
...
bpy.ops.file.pack_all();bpy.ops.wm.save_as_mainfile(filepath=str(P/'VerticalForegrip_RenderStudio.blend'))
