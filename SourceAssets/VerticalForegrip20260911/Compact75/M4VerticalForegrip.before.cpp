...
void AFPSGAMECharacter::InitializeVerticalGripAnimations()
{
    ...
    {
        const FString Path=FString::Printf(TEXT("/Game/Weapons/M4VerticalGrip/A_M4_Vertical_%s"),Pair.Value);
...
void AFPSGAMECharacter::SetVerticalForegrip(bool bEnabled)
{
    ...
    if(!VerticalForegrip)
    {
        auto* HandstopMesh=LoadObject<UStaticMesh>(nullptr,TEXT("/Game/Weapons/M4VerticalGrip/SM_VerticalForegrip"));
