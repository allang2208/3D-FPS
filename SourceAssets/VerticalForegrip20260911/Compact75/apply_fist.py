...
bpy.ops.wm.open_mainfile(filepath=str(O/'Compact_Baseline.blend'));r=bpy.data.objects['SK_M4_Infima'];data=json.loads((O/'fit_baseline.json').read_text());sol=json.loads((O/'fist_solution.json').read_text());rest=r.data.bones
