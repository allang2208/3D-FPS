...
O=Path(__file__).parent;bpy.ops.wm.open_mainfile(filepath=str(O.parent/'M4ContactImpact20260910/M4_Hand_MAT_Editable.blend'));r=bpy.data.objects['SK_M4_Infima'];s=bpy.context.scene
...
(O/'motion_audit.json').write_text(json.dumps(report,indent=2));print('MOTION_AUDIT_DONE')
for o in r.children:
