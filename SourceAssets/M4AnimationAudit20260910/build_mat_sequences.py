...
O=Path('D:/FPS3D/FPSGAME/SourceAssets/M4AnimationAudit20260910');DEST='/Game/Weapons/M4AnimationAuditFinal'
...
for clip,end in [('reload',1008),('reload_empty',1296),('equip_charge',304)]:
 seq=unreal.load_asset(DEST+'/LS_M4_AnimationAudit_'+clip) or unreal.AssetToolsHelpers.get_asset_tools().create_asset('LS_M4_AnimationAudit_'+clip,DEST,unreal.LevelSequence,unreal.LevelSequenceFactoryNew());assert seq
 ...
 anim=unreal.load_asset('/Game/Weapons/M4AnimationAuditFinal/A_M4_HK416_'+clip);assert anim.get_editor_property("number_of_sampled_keys")==end+1
