...
const COLOR_MP_FILL := Color(0.2902, 0.4157, 0.5412)           # #4a6a8a
const COLOR_STAMINA_FILL := Color(0.4784, 0.5412, 0.2902)      # #7a8a4a
const COLOR_EXP_FILL := Color(0.5412, 0.4784, 0.2902)          # #8a7a4a
const COLOR_BAR_TRACK := Color(0.15, 0.13, 0.11, 0.9)
