...
后续手腕反馈已转至 [手腕与前臂姿态修正](InfectedMinerNaturalWrist20260913.md)。本目录继续提供放大后的模型与身体动作来源；当前蓝图的三动画引用使用 `NaturalWrist20260913`。
...
待机、移动使用原躯干与腿部动作，左手移到侧后方，让镐尖贴近身后地面。本版先适配上臂/前臂，再单独对齐手部，后来出现手腕折转反馈，已由上述后续版本替代。骨长、绑定和手指姿态不重新制作。循环末帧回到各自首帧。
