...
本文记录初版。当前砍树／采矿已改为落地材料、`E` 拾取与受预算控制的破碎效果，见 [后续优化](ProductionHarvestFX-20260913.md)；树木自 2026-09-25 起按生命值结算（斧头按伤害扣血、归零才倒），见 [树木生命值与按伤害伐木](ProductionTreeHealth-20260925.md)。
