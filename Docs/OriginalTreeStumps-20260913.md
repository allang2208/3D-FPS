...
本页所述旧输出及三个 `original_stumps_*` 脚本已移入 `trash/harvest-timber-superseded-20260913`，见 [归档记录](AssetArchives/harvest-timber-superseded-20260913.md)。下文路径是历史制作位置，当前接入使用匹配切段流程。
