...
本文为历史半高版记录。2026-09-14 用户要求放大右下角武器名称与备弹栏，现行布局见 [扩展规划](ammo-readout-expanded-plan-20260914.md) 与 [正式规则第 11 节](ui-cold-steel-design-system.md#11-右下角武器名称与备弹-hud)，下列尺寸和测试结果不代表当前版本。
...
- 使用公共冷钢配色与字体；2026-09-12 已随 [正式规则 v2](ui-cold-steel-design-system.md) 改为 Noto Sans SC 和 JetBrains Mono，替换旧宋体／Consolas 条款。复用真实弹药数据，打开背包时隐藏；下方构建与验收属于原版本记录。
