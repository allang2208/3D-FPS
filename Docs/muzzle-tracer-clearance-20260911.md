...
> 2026-09-21 更新：下文"段长 45 cm、直径 0.35 cm"是当轮的历史值，早已被 V12→V13 取代（当前步枪 800/1800 cm、手枪 400/1300 cm，宽度按屏幕 4 像素换算并叠光晕层），见 [曳光弹表现升级方案](Weapons/tracer-upgrade-plan-20260921.md)。枪口出口取样与遮挡检测部分仍然有效。
