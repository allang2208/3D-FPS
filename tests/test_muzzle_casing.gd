extends SceneTree
## 无头验证：枪口火光 + 弹壳抛壳优化
## 1) 开火瞬间火光初始化：flash_t=0.06、QuadMesh 光斑、随机尺度在 [0.85,1.55]、OmniLight 就位
